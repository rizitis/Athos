...
URL = "https://download.kde.org/stable/?C=M;O=D"
CACHE_FILE = os.path.expanduser("kde_content_hash.txt")
OUTPUT_FILE = os.path.expanduser("kde_update_output.txt")
...
if current_hash != previous_hash:
    with open(OUTPUT_FILE, "w") as f:
        f.write("The KDE page has changed!\n")
    with open(CACHE_FILE, "w") as f:
        f.write(current_hash)  # Update the stored hash
else:
    with open(OUTPUT_FILE, "w") as f:
        f.write("No changes detected on the KDE page.\n")
